...
#[no_mangle]
pub extern "C" fn frbgen_shot_hdr_wire__crate__api__screen_shot_api__capture_result_to_avif(
    port_: i64,
    that: *mut wire_cst_capture_result,
) {
    wire__crate__api__screen_shot_api__capture_result_to_avif_impl(port_, that)
}
